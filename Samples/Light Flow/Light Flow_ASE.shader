...
Shader "Samples/Light Flow_ASE"
{
	Properties
	{
		...
		[Toggle]_FlowDirection("Flow Direction", Float) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				finalColor = ( tex2D( _Tex, (( _FlowDirection )?( appendResult9 ):( appendResult6 )) ) * _Color );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=17700
457;370;1167;659;1525.335;374.4266;1.3;True;False
Node;AmplifyShaderEditor.TimeNode;3;-1465.62,58.98518;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-1430.62,205.9853;Inherit;False;Property;_FlowSpeed;Flow Speed;3;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;12;-591.9679,24.43608;Inherit;False;Property;_FlowDirection;Flow Direction;2;0;Create;True;0;0;False;0;0;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;1;-364,-24.5;Inherit;True;Property;_Tex;Tex;0;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;18;-274,170.5;Inherit;False;Property;_Color;Color;1;0;Create;True;0;0;False;0;0,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=CBC56138CABD1550F7CF482BA45F765A233C38B9